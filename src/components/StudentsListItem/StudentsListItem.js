...
const StudentsListItem = (props) => {
    ...
    const {name,surname,city,scholarship,onDelete,onToggleProp,confirm,star,description} = props
        ...
        <li className={classNames} >
            ...
            <span  className="list-group-item-label " onClick={onToggleProp} data-toggle="star">{name} {surname} <div className="city"> г.{city}</div></span>
                ...
                <div className="d-flex justify-content-center align-item-center">
                    <button data-title={description} data-tooltip="вав" className="btn-cookie btn-sm" onClick={onToggleProp} data-toggle="confirm">
